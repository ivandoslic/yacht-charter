  ...
  return (
    <div className='flex flex-row'>
        ...
        <input type="hidden" name="form-name" value="email-left" />
          <input type="text" className='block w-full h-14 sm:pl-12 md:text-md rounded-l-md border-0 py-1 text-gray-900 placeholder:text-gray-400 focus:bg-[#F3F3F3]' name='email/phone' placeholder='email/phone'/>
